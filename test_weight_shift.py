...
def predict_5ma_weighted(df_train, hot_w, mid_w, cold_w):
    ...
    for d, s in s334.items(): scores[d] += s * 14 / 14
...
# 测试配置
configs = [
    (14, 10, 2, '热14-中10-冷2 (最佳)'),
    (10, 10, 6, '热10-中10-冷6 (热-4冷+4)'),
    (12, 10, 4, '热12-中10-冷4 (热-2冷+2)'),
    (13, 10, 3, '热13-中10-冷3 (热-1冷+1)'),
    (11, 10, 5, '热11-中10-冷5 (热-3冷+3)'),
    (9, 10, 7, '热9-中10-冷7 (热-5冷+5)'),
    (8, 10, 8, '热8-中10-冷8 (平分)'),
]
